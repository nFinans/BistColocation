...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex items-center gap-2 px-4 py-3 rounded-full font-semibold text-white shadow-lg transition-transform hover:scale-105"
      style={{
